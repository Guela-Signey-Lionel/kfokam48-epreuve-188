...
**Version :** 1 · **Date :** Le 25 Septembre 2026
...
| EF6   | L'étudiant peut remplacer le lien déposé tant qu'aucun relecteur ne lui a été assigné.            | Un deuxième dépôt sur la même session met à jour le lien existant tant qu'aucune relecture n'a démarré ; au-delà, il est refusé.                                                                           | Should   |
| EF7   | Le système assigne automatiquement un relecteur à chaque exercice déposé.                         | Dès qu'au moins un autre étudiant est marqué présent à la session, un relecteur est tiré au sort parmi eux (jamais l'auteur) et l'exercice passe « en attente de relecture ».                              | Must     |
...
| RG14 | Le tableau de bord du formateur affiche, par étudiant : ses présences, le nombre d'exercices déposés, la moyenne de ses notes reçues, et le nombre de relectures qu'il lui reste à faire.                   | Q16                                                     |
