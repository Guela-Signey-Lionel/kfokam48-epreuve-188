...
public class RelectureService {
    ...
    public void rendreRelecture(Long relectureId, RelectureRequest requete) {
        ...
        // Changement de besoin (V3) : l'exercice ne passe RELU que lorsque
        // TOUTES ses relectures (deux au maximum) sont rendues.
        boolean toutesRendues = relectureRepository.findByExerciceId(exercice.getId()).stream()
                .allMatch(r -> r.getStatut() == StatutRelecture.RENDUE);
        if (toutesRendues) {
